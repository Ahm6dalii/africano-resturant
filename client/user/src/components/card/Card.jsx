...
<div class="w-full  m-auto max-w-sm bg-transparent border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:bg-transparent dark:border-gray-700 ">
    ...
    <div class="desc bg-black bg-opacity-50 dark:bg-opacity-50  -bottom-[100%] transtion  duration-300 start-0 end-0 absolute opacity-0 group-hover:opacity-100 group-hover:bottom-0 text-center py-4 bg-gray-100 dark:bg-gray-700">
